...
('Administrator', 'admin', 'admin@must.ac.ug', '+256700000001', '$2y$10$8WkZ9.j/hG6K0q1p2j.zOuS6qQvQ.5/8v7qW3K8R1E4C.pD2K8Y6.', 'admin');

-- Student users (password: password)
INSERT INTO `users` (`name`, `username`, `email`, `phone`, `password`, `user_type`) VALUES
('John Doe', '2024001', 'john@must.ac.ug', '+256700000002', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'student'),
('Jane Smith', '2024002', 'jane@must.ac.ug', '+256700000003', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'student'),
('Robert Musiime', '2024003', 'robert@must.ac.ug', '+256700000004', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'student');

-- Routes
INSERT INTO `routes` (`route_code`, `route_name`, `origin`, `destination`, `price`) VALUES
('RT001', 'Campus to Town Center', 'Main Campus', 'Town Center', 1000.00),
('RT002', 'Town Center to Campus', 'Town Center', 'Main Campus', 1000.00),
('RT003', 'Campus to Hostels', 'Main Campus', 'Student Hostels', 500.00);
